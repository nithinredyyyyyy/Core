  ...
  participants: [
    {
      placement: 1,
      team: "DUKSAN Esports",
      phase: "Korea Pro Series",
      players: ["JUNI", "BINI", "ZIPYAN", "Hoxy", "Qx"],
    },
    {
      placement: 2,
      team: "Dplus",
      phase: "Korea Pro Series",
      players: ["FAVIAN", "FOREST", "OSAL", "Nolbu", "LLLL"],
    },
    {
      placement: 3,
      team: "ZZ",
      phase: "Korea Pro Series",
      players: ["Cyxae", "Kay", "Y2NMON", "Chicken"],
    },
    {
      placement: 4,
      team: "Eagle Owls",
      phase: "Korea Pro Series",
      players: ["NOVA", "Danxy", "Junior", "SAEWOO"],
    },
    {
      placement: 5,
      team: "EmTek StormX",
      phase: "Korea Pro Series",
      players: ["AMEN", "Yeon", "Shun", "Clutch", "Eternal"],
    },
    {
      placement: 6,
      team: "NS RedForce",
      phase: "Korea Pro Series",
      players: ["TIZ1", "SPORTA", "WingS", "XZY", "Janchi"],
    },
    {
      placement: 7,
      team: "Maru Gaming",
      phase: "Korea Pro Series",
      players: ["Sine", "WHORU", "DDaHo", "TheShy"],
    },
    {
      placement: 8,
      team: "ROX",
      phase: "Korea Pro Series",
      players: ["Auto", "Ratel", "iDtt", "Timon", "Pumbaa", "KingMam"],
    },
    {
      placement: 9,
      team: "Gladiators Esports",
    ...
    },
    {
      ...
      team: "Blind Esports",
      phase: "India Series",
      players: ["Manya", "NakuL", "Rony", "Jokerr", "Spower", "Ayogi"],
    },
    {
      placement: 13,
      team: "Gods Reign",
      phase: "India Series",
      players: ["AquaNox", "NinjaJOD", "Blaze", "Robin", "Owais"],
    },
    {
      placement: 14,
      team: "Medal Esports",
...
const tx = db.transaction(() => {
  ...
  for (const team of teams) {
    ...
    upsertTeam.run(
      ...
      "BGMI",
      team.name === "Dplus" ||
        team.name === "EmTek StormX" ||
        team.name === "Eagle Owls" ||
        team.name === "NS RedForce" ||
        team.name === "ZZ" ||
        team.name === "DUKSAN Esports" ||
        team.name === "ROX" ||
        team.name === "Maru Gaming"
        ? "South Korea"
        : "India",
      0,
      0,
