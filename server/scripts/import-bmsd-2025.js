  ...
  participants: [
    {
      placement: 1,
      team: "GodLike Esports",
      phase: "Upper Bracket Invited",
      players: ["Punkk", "ADMINO", "JONATHAN", "Godz", "SIMP"],
    },
    {
      placement: 2,
      team: "8Bit",
      phase: "Upper Bracket Invited",
      players: ["Saumraj", "Spower", "AquaNox", "Raiden", "BeastOG"],
    },
    {
      placement: 3,
      team: "True Rippers",
      phase: "Upper Bracket Invited",
      players: ["Jelly", "KioLmao", "Harsh", "Hydro"],
    },
    {
      placement: 4,
    ...
    },
    {
      ...
      team: "Gods Omen",
      phase: "Upper Bracket Invited",
      players: ["LUCIFER", "BEAST04", "ARTO", "SHOGUN", "MAX"],
    },
    {
      placement: 6,
      team: "Team Aryan",
      phase: "Upper Bracket Invited",
      players: ["Aryan", "Devotee", "Syrax", "Henry"],
    },
    {
      placement: 7,
      team: "Los Hermanos Esports",
      phase: "Upper Bracket Invited",
      players: ["ShaDow", "Kaalan", "Zhyrx", "SpyOp", "Evil"],
    },
    {
      placement: 8,
      team: "Orangutan",
      phase: "Upper Bracket Invited",
      players: ["Aaru", "AKop", "WizzGOD", "Attanki"],
    },
    {
      placement: 9,
      team: "Marcos Gaming",
      phase: "Upper Bracket Invited",
      players: ["StoneBGMI", "Nodii", "W1ZARD", "BadOP", "GyroGod"],
    },
    {
      placement: 10,
      team: "4TR Official",
      phase: "Upper Bracket Invited",
      players: ["Morty", "PainIsLive", "ZGOD", "InfGod", "AKOP", "Utkarsh"],
    },
    {
      placement: 11,
      team: "Gods Reign",
      phase: "Upper Bracket Invited",
      players: ["Destro", "Justin", "DeltaPG", "Neyo"],
    },
    {
      placement: 12,
      team: "K9 Esports",
      phase: "Upper Bracket Invited",
      players: ["Omega", "NinjaBoi", "Slug", "Beast"],
    },
    {
      placement: 13,
      team: "Team SouL",
      phase: "Upper Bracket Invited",
      players: ["NakuL", "Goblin", "LEGIT", "Jokerr", "Thunder"],
    },
    {
      placement: 14,
      team: "EvoX Esports",
      phase: "Upper Bracket Invited",
      players: ["PmwiIGL", "OwenOG", "Archit", "Aadi07", "Executor"],
    },
    {
      placement: 15,
      team: "Reckoning Esports",
      phase: "Upper Bracket Invited",
      players: ["Dionysus", "Javin", "Flawk", "Ninjuu", "Shubh"],
    },
    {
      placement: 16,
      team: "Cincinnati Kids",
      phase: "Upper Bracket Invited",
      players: ["Juicy", "Saumay", "Skipz", "Zeref", "Zin"],
    },
    {
      placement: 17,
      team: "Medal Esports",
      phase: "Upper Bracket Invited",
      players: ["VeNoM", "ALTU", "A1mbot", "Termi"],
    },
    {
      placement: 18,
      team: "Genesis Esports",
      phase: "Upper Bracket Invited",
      players: ["GravityJOD", "HunterZ", "ViPER", "Zap", "Yash"],
    },
    {
      placement: 19,
      team: "Victores Sumus",
      phase: "Upper Bracket Invited",
      players: ["Owais", "Mafia36", "Shayaan", "SAM", "Ninzae"],
    },
    {
      placement: 20,
      team: "FS Esports",
      phase: "Upper Bracket Invited",
      players: ["Roman", "Levi", "Lovish", "Godx", "Sarvit"],
    },
    {
      placement: 21,
      team: "NoNx Esports",
      phase: "Upper Bracket Invited",
      players: ["Kanha", "Rapido", "Anonymous", "Kalyug", "VipeR"],
    },
    {
      placement: 22,
      team: "First Curiosity",
      phase: "Upper Bracket Invited",
      players: ["DreamS", "GamlaBoy", "AnujTooOP", "Crypto", "Insidious"],
    },
    {
      placement: 23,
      team: "Meta Ninza",
      phase: "Upper Bracket Invited",
      players: ["DragonOP", "PokoWNL", "BeardBaba", "Reaper", "Rico"],
    },
    {
      placement: 24,
      team: "Bot Army",
      phase: "Upper Bracket Invited",
      players: ["Lionn", "Pratik", "Wanted", "Monty", "FraggerNUB"],
    },
    {
      placement: 25,
      team: "Blitz Esports",
      phase: "Lower Bracket Invited",
      players: ["SarwarOG", "ChandanOP", "SOHAM", "Nova21", "Sourav"],
    },
    {
      placement: 26,
      team: "Phoenix Esports",
      phase: "Lower Bracket Invited",
      players: ["Ash", "Veyron", "PHANTOM", "Shirajj"],
    },
    {
      placement: 27,
      team: "Gravity Esports",
      phase: "Lower Bracket Invited",
      players: ["Draxxy", "Knight", "Devil03", "Sujal", "OSIRIS"],
    },
    {
      placement: 28,
      team: "Vasista Esports",
      phase: "Lower Bracket Invited",
      players: ["Hector", "ScaryJod", "SahilOPAF", "ProBGMI", "Jasleen"],
    },
    {
      placement: 29,
      team: "Rider Esports",
      phase: "Lower Bracket Invited",
      players: ["FRAGGER16", "FAMEeeee", "XzisT", "SyedOP", "Kyllo"],
    },
    {
      placement: 30,
      team: "StreamO",
      phase: "Lower Bracket Invited",
      players: ["Sporta", "Ragnar", "Vampi", "GautamFL", "SpiritOP"],
    },
    {
      placement: 31,
      team: "GENxFM Esports",
      phase: "Lower Bracket Invited",
      players: ["GOKU", "HONEY", "Dope1", "DhruvOG", "Sheek"],
    },
    {
      placement: 32,
      team: "Altitude",
      phase: "Lower Bracket Invited",
      players: ["Godz", "Cloudz", "Lazyy", "PrimeOG", "BunnY"],
    },
    {
      placement: 33,
      team: "Revenant XSpark",
      phase: "Lower Bracket Invited",
      players: ["SENSEI", "Tracegod", "FurY", "Fierce", "Goten"],
    },
    {
      placement: 34,
      team: "Team Tamilas",
      phase: "Lower Bracket Invited",
      players: ["MrIGL", "FoxOP", "Lens77", "AIMGOD"],
    },
    {
      placement: 35,
      team: "GlitchXReborn",
      phase: "Lower Bracket Invited",
      players: ["Avii", "Ralph", "Jimjam", "Utkarsh", "Fanta"],
    },
    {
      placement: 36,
      team: "TWOB",
      phase: "Lower Bracket Invited",
      players: ["Aditya", "Pukar", "Mac", "JatinOG", "RageGod"],
    },
    {
      placement: 37,
      team: "Team Versatile",
      phase: "Lower Bracket Invited",
      players: ["Shadow7", "Sarang", "NinjaJOD", "Rony"],
    },
    {
      placement: 38,
      team: "TEAM iNSANE",
      phase: "Lower Bracket Invited",
      players: ["EGGY", "DREAMS03", "JDGamingYT", "SpiderJOD"],
    },
    {
      placement: 39,
      team: "2OP Official",
      phase: "Lower Bracket Invited",
      players: ["Topdawg", "Botfire", "Liability", "Shorty", "Lucky2Nub"],
    },
    {
      placement: 40,
      team: "Alibaba Raiders",
      phase: "Lower Bracket Invited",
      players: ["Kris", "Tiger", "Joyesh", "Scuba"],
    },
    {
      placement: 41,
      team: "Sinewy Esports",
      phase: "Lower Bracket Invited",
      players: ["Moksh", "Vishu9", "Turbo", "NinjA", "RexBoy13"],
    },
    {
      placement: 42,
      team: "MYSTERIOUS 4",
      phase: "Lower Bracket Invited",
      players: ["Omega", "Bunny", "HEROO", "SnowJOD", "NAMAN"],
    },
    {
      placement: 43,
      team: "Troy Tamilans Esports",
      phase: "Lower Bracket Invited",
      players: ["RanveerOG", "Pekka", "Auxin", "Akshu", "Dazzle"],
    },
    {
      placement: 44,
      team: "White Walkers",
      phase: "Lower Bracket Invited",
      players: ["FLASH", "Arjun", "VEGITO", "PSYCHO", "Arther"],
    },
    {
      placement: 45,
      team: "Madkings Esports",
      phase: "Lower Bracket Invited",
      players: ["SHADOW", "ClutchGod", "Apollo", "PRO", "FRAGGER"],
    },
    {
      placement: 46,
      team: "Nebula Esports",
      phase: "Lower Bracket Invited",
      players: ["Aadi", "KRATOS", "Phoenix", "KnowMe", "Ryu"],
    },
    {
      placement: 47,
      team: "Autobotz Esports",
      phase: "Lower Bracket Invited",
      players: ["Areeb", "Toxic", "Ralphie", "RushBoy", "Lobster"],
    },
    {
      placement: 48,
      team: "Wyld Fangs",
      phase: "Lower Bracket Invited",
      players: ["Manya", "SPRAYGOD", "Saif", "WhiteTiger", "Troye"],
    },
  ],
  rankings: [
    {
    ...
    },
    {
      ...
      standings: [
        ...
        },
        {
          placement: 14,
          team: "CK",
          fullTeam: "OnePlus Cincinnati Kids",
          matches: 18,
          wwcd: 0,
          pos: 27,
          elimins: 60,
...
console.log(
  "Imported BMSD 2025 tournament, participants, schedule, standings, rankings, and article.",
);
