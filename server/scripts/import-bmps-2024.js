...
const tournament = {
  ...
  stages: [
    {
      name: "League Stage", order: 1, status: "completed", teamCount: 128,
      summary: "Aug 20th - Sept 18th, 2024. BMPS 2024 began with 128 teams and progressed through Round 1, Round 2, Round 3, and Semi Finals before locking the 16 Grand Finalists.",
      standings: [],
    },
    {
      name: "Round 1", order: 2, status: "completed", teamCount: 128,
      summary: "Aug 20th - 27th and Aug 29th - Sept 5th, 2024. Teams were split into Red and Blue groups, each divided into 4 sub-groups of 16. After 16 matchdays and a mid-stage reshuffle, the top 64 teams advanced.",
      standings: [],
    },
    {
      name: "Round 2", order: 3, status: "completed", teamCount: 64,
      summary: "Sept 7th - 10th, 2024. 64 teams were divided into 4 groups of 16 and each team played 6 matches. The top 48 teams overall moved on to Round 3.",
      standings: [],
    },
    {
      name: "Round 3", order: 4, status: "completed", teamCount: 48,
      summary: "Sept 11th - 14th, 2024. 48 teams were divided into 3 groups of 16 with reshuffles after two days. Each team played 8 total matches and the top 24 overall advanced to Semi Finals.",
      standings: [],
    },
    {
      name: "Semi Finals", order: 5, status: "completed", teamCount: 24,
      summary: "Sept 15th - 18th, 2024. 24 teams were divided into 3 groups of 8 in a double round-robin format. Each team played 16 matches and the top 16 overall qualified for the Grand Finals.",
      standings: [],
    },
    {
      name: "Grand Finals", order: 6, status: "completed", teamCount: 16,
      summary: "Sept 27th - 29th, 2024 at Adlux International Convention Centre, Kochi. 16 teams competed across 18 matches, with Team XSpark claiming the championship on 158 total points.",
      standings: [
...
const grandFinalSchedule = [
  "2024-09-27T13:30:00+05:30", "2024-09-27T14:20:00+05:30", "2024-09-27T15:10:00+05:30",
  "2024-09-27T16:00:00+05:30", "2024-09-27T16:50:00+05:30", "2024-09-27T17:40:00+05:30",
  "2024-09-28T13:30:00+05:30", "2024-09-28T14:20:00+05:30", "2024-09-28T15:10:00+05:30",
  "2024-09-28T16:00:00+05:30", "2024-09-28T16:50:00+05:30", "2024-09-28T17:40:00+05:30",
  "2024-09-29T13:30:00+05:30", "2024-09-29T14:20:00+05:30", "2024-09-29T15:10:00+05:30",
  "2024-09-29T16:00:00+05:30", "2024-09-29T16:50:00+05:30", "2024-09-29T17:40:00+05:30",
];
...
importTournament({
  ...
  getStandingsForStage: (stageName) => {
    ...
    return tournament.stages.find((s) => s.name === "Grand Finals").standings.map((s) => ({
  ...
  insertMatchSchedule: (tournamentId) => {
    ...
    grandFinalSchedule.forEach((scheduledTime, index) => {
      insertMatch.run(
        randomUUID(), tournamentId, "Grand Finals", index + 1,
        mapRotation[index % mapRotation.length], "completed",
        scheduledTime, null, Math.floor(index / 6) + 1,
  ...
  articles: [
    {
      ...
      content: "Team XSpark won BMPS 2024 with 158 total points in the Grand Finals, finishing ahead of Team Forever and Hero Xtreme Godlike. The event featured a ₹2 crore prize pool and concluded on September 29, 2024 in Kochi.",
      category: "tournament",
      game: "BGMI",
      featured: 1,
    },
...
console.log("Imported BMPS 2024 tournament, finalists, schedule, standings, and article.");
