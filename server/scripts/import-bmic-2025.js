...
const tournament = {
  ...
  participants: [
    ...
    },
    {
      placement: 9,
      team: "Dplus",
      phase: "Pro Series Korea",
      players: ["chpz", "OSAL", "FAVIAN", "Nolbu", "FOREST"],
    },
    {
      placement: 10,
      team: "Nongshim RedForce",
      phase: "Pro Series Korea",
      players: ["DokC", "BINI", "XZY", "TIZ1"],
    },
    {
      placement: 11,
      team: "Jecheon Phalanx",
      phase: "Pro Series Korea",
      players: ["SPORTA", "SIxTa", "Hollywood", "Crazy"],
    },
    {
      placement: 12,
      team: "DRX",
      phase: "Pro Series Korea",
      players: ["Cyxae", "HYUNBIN", "Qx", "SOEZ"],
    },
    {
      placement: 13,
      team: "REJECT",
      phase: "Japan League",
      players: ["Apollo", "ReijiOcO", "Duelo", "Devine", "SaRa"],
    },
    {
      placement: 14,
      team: "REIGNITE",
      phase: "Japan League",
      players: ["Nagon", "TTP", "YamaK", "miz"],
    },
    {
      placement: 15,
      team: "MAKING THE ROAD",
      phase: "Japan League",
      players: ["ItsuQ", "REX", "Aibo", "PINE"],
    },
    {
      placement: 16,
      team: "CAG OSAKA",
      phase: "Japan League",
      players: ["Garnet", "Sheep", "Naoto", "Mattun"],
    },
  ],
  rankings: [
    {
...
console.log(
  "Imported BMIC 2025 tournament, participants, schedule, standings, rankings, and article.",
);
