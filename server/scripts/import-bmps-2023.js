  ...
  participants: [
    {
      ...
      team: "TEAM iNSANE",
      phase: "League Stage",
      players: ["Aadi", "Tsunami", "Jazzyy", "Darklord", "Skipz"],
    },
    {
      placement: 2,
      team: "Blind eSports",
      phase: "League Stage",
      players: ["Spower", "Manya", "Rony", "NakuL", "Jokerr", "Ayogi"],
    },
    {
      placement: 3,
      team: "Growing Strong",
      phase: "League Stage",
      players: ["Faith", "EclipseOP", "Sparkey", "Godbott"],
    },
    {
      placement: 4,
      team: "Team SouL",
      phase: "League Stage",
      players: ["Goblin", "Omega", "AkshaT", "Hector", "Neyo", "Amit"],
    },
    {
      placement: 5,
      team: "Hydra",
      phase: "League Stage",
      players: ["DuoraOP", "SparshOP", "Spraygod", "Starboy"],
    },
    {
      placement: 6,
      team: "Autobotz Esports",
    ...
    },
    {
      ...
      team: "Team Psyche",
      phase: "League Stage",
      players: ["Vampire", "Orva", "Orzi", "Saad", "Striker", "Ravan"],
    },
    {
      placement: 9,
      team: "GlitchXReborn",
      phase: "League Stage",
      players: ["Roman", "Ralph", "Scuba", "Duke", "Kris"],
    },
    {
      placement: 10,
      team: "TeamXSpark",
      phase: "League Stage",
      players: ["Pukar", "Sarang", "DreamS", "SPRAYGOD", "ScoutOP", "Osmium"],
    },
    {
      placement: 11,
      team: "Team Together Esports",
    ...
    },
    {
      ...
      team: "Revenant Esports",
      phase: "League Stage",
      players: ["SENSEI", "MJ", "Fierce", "Apollo", "SIMP"],
    },
    {
      placement: 13,
      team: "8Bit x CS Esports",
      phase: "League Stage",
      players: ["Juicy", "Mighty", "Sarthak", "Ronak", "LeeoYT", "Ranadip"],
    },
    {
      placement: 14,
      team: "Gladiators Esports",
      phase: "League Stage",
      players: ["Destro", "DeltaPG", "Justin", "SHOGUN"],
    },
    {
      placement: 15,
      team: "Entity Gaming",
      phase: "League Stage",
      players: ["Saumraj", "GamlaBoy", "Troye", "Gabbar", "Siuuu786", "Xypex"],
    },
    {
      placement: 16,
      team: "Numen Esports",
      phase: "League Stage",
      players: ["SHADOW", "ClutchGod", "GiLL", "Savitar", "Wixxky"],
    },
  ],
  rankings: [
    {
    ...
    },
    {
      ...
      standings: [
        ...
        },
        {
          placement: 13,
          team: "TTE",
          fullTeam: "Team Together Esports",
          matches: 18,
          wwcd: 0,
          pos: 71,
          elimins: 29,
...
const teams = [
  ...
  {
    name: "Team Together Esports",
    tag: "TTE",
    players: ["ParaBTC", "SeviPlays", "Saikat09", "Krunal", "Pikachu", "Rolex"],
  },
  {
    name: "Growing Strong",
    tag: "GS",
...
console.log(
  "Imported BMPS 2023 tournament, finalists, schedule, standings, and article.",
);
