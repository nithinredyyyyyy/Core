...
const tournament = {
  ...
  participants: [
    {
      ...
      players: ["Kaalan", "Evil", "ShaDow", "SpyOp", "Tonyy"],
    },
    {
      placement: 2,
      team: "IQOO SouL",
    ...
    },
    {
      ...
      team: "Meta Ninza",
      phase: "Quarter Finals",
      players: ["Shadow7", "Fierce", "Apollo", "WhiteTiger", "Javin"],
    },
    {
      placement: 4,
      team: "IQOO Orangutan",
      phase: "Quarter Finals",
      players: ["AK", "Aaru", "Attanki", "WizzGOD"],
    },
    {
      placement: 5,
      team: "4 Wolf x DOD",
      phase: "Quarter Finals",
      players: ["IMMORTAL", "AVNISHOP", "BHAALU", "NooB", "PIXIEOP"],
    },
    {
      placement: 6,
      team: "MadKings",
      phase: "Quarter Finals",
      players: ["SHADOW", "ClutchGod", "Syrax", "PRO"],
    },
    {
      placement: 7,
      team: "Sinewy Esports",
      phase: "Quarter Finals",
      players: ["Moksh", "Vishu99", "Ninjuu", "Rexboy", "NinjA"],
    },
    {
      placement: 8,
      team: "Genesis Esports",
    ...
    },
    {
      ...
      team: "IQOO Team Tamilas",
      phase: "Quarter Finals",
      players: ["AIMGOD", "FoxOP", "MrIGL", "Reaper"],
    },
    {
      placement: 10,
      team: "Troy Tamilan Esports",
      phase: "Quarter Finals",
      players: ["Auxin", "Ayden", "Lens77", "Hesperos", "Jazzy"],
    },
    {
      placement: 11,
      team: "Vasista Esports",
      phase: "Quarter Finals",
      players: ["Beast", "FusionOP", "Hector", "Saumay", "Shayaan"],
    },
    {
      placement: 12,
      team: "Hero Xtreme GodLike",
      phase: "Quarter Finals",
      players: ["Spower", "ADMINO", "Godz", "JONATHAN", "Manya"],
    },
    {
      placement: 13,
      team: "Wyld Fangs",
    ...
    },
    {
      ...
      team: "IQOO Revenant XSpark",
      phase: "Quarter Finals",
      players: ["NinjaJOD", "JDGamingYT", "Pain09", "Punkk", "Tracegod"],
    },
    {
      placement: 15,
      team: "Welt Esports",
      phase: "Quarter Finals",
      players: ["GokulWNL", "Proton", "Maxioso", "Shyam", "JustyOp"],
    },
    {
      placement: 16,
      team: "Learn From Past",
    ...
    },
    {
      ...
      team: "Nebula Esports",
      phase: "Wildcard",
      players: ["Aadi", "KnowMe", "KRATOS", "Phoenix", "Ryu"],
    },
    {
      placement: 18,
      team: "Team Vanguard",
      phase: "Wildcard",
      players: ["DreamS", "Insidious", "Dionysus", "Crypto", "AnujTooOP"],
    },
    {
      placement: 19,
      team: "NONx Esports",
    ...
    },
    {
      ...
      team: "Victores Sumus",
      phase: "Wildcard",
      players: ["Owais", "Mafia36", "VeNoM", "ScaryJod", "Sarang"],
    },
    {
      placement: 22,
      team: "Phoenix Esports",
      phase: "Wildcard",
      players: ["Saumraj", "SIMP", "Smoker46", "Stranger", "VipeR"],
    },
    {
      placement: 23,
      team: "IQOO Reckoning Esports",
      phase: "Wildcard",
      players: ["Godx", "Levi", "Lovish", "Roman", "SahilOPAF"],
    },
    {
      placement: 24,
      team: "Myth Official",
  ...
  stages: [
    ...
    },
    {
      ...
      teamCount: 64,
      summary:
        "Quarter Finals: Feb 26th - Mar 1st, 2026. 64 teams, 4 matchdays. 56 teams from Round 4 and the top 8 teams from The Grind Group A were divided into 4 groups of 16. Each team played 6 matches. The top 16 teams in the cumulative standings advanced to Semi Finals, while 17th-40th moved to Wildcard.",
      standings: [
        {
          placement: 1,
          team: "EvoX Esports",
    ...
    },
    {
      ...
      teamCount: 32,
      summary:
        "Wildcard: Mar 5th - 8th, 2026. 32 teams, 4 matchdays. 24 teams came from Quarter Finals and 8 teams from Round 4. Teams were divided into 4 groups with 8 teams each and played a 12-match round-robin. The top 8 in the cumulative standings advanced to Semi Finals.",
      standings: [
        {
          placement: 1,
          team: "Nebula Esports",
    ...
    },
    {
      ...
      teamCount: 24,
      summary:
        "Semi Finals: Mar 12th - 15th, 2026 at Sandhya Convention Center, Hyderabad. 24 teams, 4 matchdays. 16 teams came from Quarter Finals and 8 from Wildcard. Teams were divided into 3 groups of 8 and played a 16-match double round-robin. The top 8 advanced to Grand Finals and the remaining 16 moved to Survival Stage.",
      standings: [
        {
          placement: 1,
          team: "IQOO SouL",
    ...
    },
    {
      ...
      teamCount: 16,
      summary:
        "Survival Stage: Mar 16th - 17th, 2026 at Sandhya Convention Center, Hyderabad. 16 teams, 2 matchdays, 12 matches total with 6 each day. The top 8 teams advanced to Grand Finals.",
      standings: [
        {
          placement: 1,
          team: "Hero Xtreme GodLike",
    ...
    },
    {
      ...
      teamCount: 16,
      summary:
        "Grand Finals: Mar 27th - 29th, 2026 at Chennai Trade Centre, Chennai. 16 teams, 3 matchdays, and 18 matches with 6 each day. 8 teams qualified from Semi Finals and 8 from Survival Stage, with IQOO SouL winning the title on 173 points.",
      standings: [
        {
          placement: 1,
          team: "SOUL",
...
console.log(
  "Imported BGIS 2026 tournament, schedule, teams, players, standings, and news.",
);
