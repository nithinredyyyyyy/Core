  ...
  return (
    <FansPanel className="overflow-hidden">
      <div className="flex items-center gap-2 border-b border-border/70 px-4 py-3.5">
        ...
        <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-muted-foreground">Fan leaderboard</p>
      </div>
        ...
        {profiles.slice(0, 2).map((entry) => (
          <div
            ...
            className={`rounded-[16px] border px-3 py-3 ${
              entry.isYou ? "border-primary/25 bg-primary/10" : "border-border/70 bg-white/90"
            }`}
          >
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[15px] font-black tracking-[-0.03em] text-slate-900">
                    {entry.display_name}
                    {entry.isYou ? <span className="ml-1.5 text-[11px] uppercase text-primary">You</span> : null}
                  </p>
              ...
              <div className="text-right">
                <p className="text-lg font-black text-primary">{entry.total_points}</p>
